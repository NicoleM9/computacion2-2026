...
class ConnectionPool:
    ...
    def mostrar_estadisticas(self):
        ...
        print(
            f"Total requests: "
            f"{self.estadisticas['total_requests']}"
        )

        print(
            f"Requests que esperaron: "
            f"{self.estadisticas['esperas']}"
        )
        ...
        if self.estadisticas["esperas"] > 0:
            ...
            promedio = (
                ...
                / self.estadisticas["esperas"]
            )

            print(
                f"Tiempo promedio espera: "
                f"{promedio:.3f}s"
            )
